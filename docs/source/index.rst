...
**Any gap geometry.**  Uniform, sphere-plane, sphere-sphere, hyperboloid-plane
and coaxial gaps are analytic.  A **tabulated field line** from an external electrostatic solver
